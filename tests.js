...
// let testUsers2 = [{ id : 1 }, { id : 12, randomm : "das" }];
// let testUsers2 = [];
...
// console.log("The function returned should return", true," for the given list", testUsers1," : ", fifth(goodUsers)(testUsers2) === true );
// console.log("The function returned should return", true," for the given list", testUsers3," : ", fifth(goodUsers)(testUsers3) === true );

let fifth = require('./reduceProg');
